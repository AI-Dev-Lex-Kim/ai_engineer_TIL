...
텍스트 스플리터는 <mark>**큰 문서를 작은 조각으로 나눠**</mark>서, 각 조각이 <mark>**개별적으로 검색 가능**</mark>하도록 만들고 모델의 <mark>**컨텍스트 윈도우 제한안에 들어오도록 한다.**</mark>

<br>

<mark>**문서를 나누는 것을 청킹**</mark>이라 부르며, <mark>**나눠진 문서는 청크**</mark>라고 부른다.
