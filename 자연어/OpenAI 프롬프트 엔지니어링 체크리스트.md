...
- [ ] <mark>**`<identity>`: 모델에 명확한 역할을 부여했는가?**</mark>
  - "너는 고객 문의에 응대하는 전문 상담원이다." 와 같이 구체적인 정체성을 부여하면, 모델의 응답 톤, 어휘 선택, 행동 방식이 일관성을 갖게 된다.
- [ ] <mark>**`<context>`: 모델이 처리할 데이터를 명시적으로 구분했는가?**</mark>
...
- [ ] <mark>**예시 문구를 그대로 사용하지 않도록 지시했는가?**</mark>
