...
1. <mark>**Input processing**</mark> – 원시 데이터를 구조화된 문서로 바꾸는 단계
2. <mark>**Embedding & storage**</mark> – 텍스트를 벡터로 바꿔 저장하는 단계
3. <mark>**Retrieval**</mark> – 사용자 질문과 관련된 정보를 찾는 단계
4. <mark>**Generation**</mark> – AI가 답변을 생성하는 단계
