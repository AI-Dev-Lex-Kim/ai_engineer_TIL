...
컴퓨터는 글자를 숫자로 변환한 후, **벡터(Vector) 형태로 저장**.
...
- **D = [0, 0, 0, 1, 0]**
- **E = [0, 0, 0, 0, 1]**
  이런 식으로 표현하면, 컴퓨터가 **각 글자가 어떤 의미인지 쉽게 구별**할 수 있다!
  **글자는 벡터(숫자 배열)로 변환 가능하다!**
...
즉, 특정 순간의 소리 크기를 숫자로 변환해서 **벡터로 저장**한다!
